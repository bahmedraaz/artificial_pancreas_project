...
#
		...
		if glucose > bg_target and (glucose-prev_glucose)>0: ## glucose is above target and rising
			...
			if (iob - prev_iob) < 0 or (iob-prev_iob)==0: ## checking if iob is falling or stable
				if recommended_change_rate < 0:
					...
					loaded_suggested_data["fault"] = "yes"
					loaded_suggested_data["fault_reason"] = "Reason: glucose>target and rising; iob is falling or stable; rate should not be decreased" 
					print("\n***************************************")
					print("********** Faultiy !!!!! *************")  	
	...
	################## Context table 3rd and 4th row (bg>target and stable, iob is falling and stable)################################
			...
			if (iob - prev_iob) < 0 or (iob-prev_iob)==0:
				if recommended_change_rate < 0:
					...
					loaded_suggested_data["fault"] = "yes"
					loaded_suggested_data["fault_reason"] = "Reason: glucose>target and stable; iob is falling or stable; rate should not be decreased" 
					print("\n***************************************")
					print("********** Faultiy !!!!! *************")  	
	...
	################## Context table 5th and 6th row (bg<target and falling, iob is rising and stable)################################
			...
			if (iob - prev_iob) > 0 or (iob-prev_iob)==0:
				if recommended_change_rate > 0:
					...
					loaded_suggested_data["fault"] = "yes"
					loaded_suggested_data["fault_reason"] = "Reason: glucose<target and falling; iob is rising or stable; rate should not be increased" 
					print("\n***************************************")
					print("********** Faultiy !!!!! *************")  	
	...
	################## Context table 7th row (bg<target and stable, iob is rising)################################
			...
			if (iob - prev_iob) > 0:
				if recommended_change_rate > 0:
					...
					loaded_suggested_data["fault"] = "yes"
					loaded_suggested_data["fault_reason"] = "Reason: glucose<target and stable; iob is rising; rate should not be increased" 
					print("\n***************************************")
					print("********** Faultiy !!!!! *************")  	
	...
	################## Context table 8th row, bg>target and zero insulin is provided)################################
			...
			loaded_suggested_data["fault"] = "yes"
			loaded_suggested_data["fault_reason"] = "Reason: glucose > target and zero insulin is provided" 
			print("\n***************************************")
			print("********** Faultiy !!!!! *************")  	
